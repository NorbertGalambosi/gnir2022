...
//test add contact ( I )
        try {
            contact = new Contact("BigBangTestContact", "address1", "+4071122334455", "email@dom.com");
        } catch (Exception e) {
            assertTrue(true);
        }
...
//test add activity ( II )
        ...
        try {
            ...
            activity = new Activity("nameul",
                    ...
                    df.parse("03/20/2013 13:00"),
                    contactList,
                    "Cumparam mobila", "BigBangTestActivity",
                    "Casa Rusu");
...
//test search for activities ( III )
        ...
        try {
            assertTrue("1 Activity found ", 1 ==
                    repositoryActivity.activitiesOnDate("BigBangTestActivity", date.parse("03/20/2013")).size());
        } catch (ParseException e) {
            e.printStackTrace();
        }
